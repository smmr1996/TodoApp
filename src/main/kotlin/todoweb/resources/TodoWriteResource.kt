 ...
 *
 * This interface defines the methods to write "To-do" into the Data Source.
 *
...
interface TodoWriteResource {
     ...
     * having particular [id]. Returns a [Response] with the updated "To-do" or exception/failure caused.
     */
    fun updateTodoById(id: Long, todoJson: String): Response

    /**
     * A POST method which takes a [todoJson] as an input and persists it in the DB. Returns a [Response]
     * with the created "to-do"
     */
